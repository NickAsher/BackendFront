...
$RestaurantInfo = array(
    'rest_name'=>'Buffalo Wild Wings & Bar',
    'rest_image'=>'../../../images/restaurant_logo.png',
    'rest_addr_1'=>'Next Step Webs, Inc.',
    'rest_addr_2'=>'12345 Sunny Road',
    'rest_addr_3'=>'Sunnyville, TX 12345',
) ;
$OrderInfo = isSecure_checkPostInput('__order_info') ;
$OrderInfo = json_decode($OrderInfo, true) ;


$Cart = $OrderInfo['cart_json'] ;
$Tax = $OrderInfo['tax_json'] ;
...
<div  id="outer-box">
    ...
    <table class='table'>
        ...
        <tr>
            <td>
                Order No : <?php echo $OrderInfo['order_no'] ?><br>
                Date: <?php echo $OrderInfo['order_date'] ?><br>
                Time: <?php echo $OrderInfo['order_time'] ?>
            </td>

            <td style='text-align: right;'>
                <?php echo $OrderInfo['customer_info']['customer_name'] ?><br>
                <?php echo $OrderInfo['customer_info']['customer_num'] ?><br>
                <?php echo $OrderInfo['customer_info']['customer_email'] ?>
            </td>
        </tr>
    </table>
    <br>
    ...
    <div class='row' id="pricetable">
        ...
        <div class=' col-6 col-sm-6 col-md-6'>
            <table class='table table-sm borderless'>
                ...
                <tr>
                    <th>Sub Total</th>
                    <th  class='right'><?php echo ($OrderInfo['net_price'] - $OrderInfo['coupon_discount'])  ?></th>
                </tr>
