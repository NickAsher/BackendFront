...
<!--    <link rel="stylesheet" href="../../../../lib/reset/reset.css" >-->
    ...
    $AllAddonGroupInCategoryListArray = getListOfAllAddonGroupsInACategory_Array($DBConnectionBackend, $CategoryCode) ;
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <ol id="yo" class="hidden-list-numbering" style="display: inline-block;float: left">
                            <?php
                            foreach ($AllAddonGroupInCategoryListArray as $Record){
                                echo "<li></li>" ;
                            }
                            ?>
                        ...
                        <ol id="sorting" class="listo-group">
                            ...
                            foreach ($AllAddonGroupInCategoryListArray as $Record){
                                ...
                                echo "<li id='$RelId'>$AddonGroupDisplayName</li>" ;
                            }
                            ?>
