                    ...
                    <div id="Section_AddNewItemForm" class="col-md-10" >
                        <form action="process-edit-size.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input name="__size_code" id="input-size-code" class="form-control" type="text" value="<?php echo $Record['size_code'] ; ?> " >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input name="__size_name" id="input-size-name" class="form-control" type="text"  value="<?php echo $Record['size_name'] ?>" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input name="__size_name_abbr" id="input-size-name_abbr" class="form-control" type="text"  value="<?php echo $Record['size_name_short'] ?>" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input name="__size_sr_no" id="input-size-sr_no" class="form-control" type="number"  value="<?php echo $Record['size_sr_no'] ?>" >
                                </div>
                            </div>
