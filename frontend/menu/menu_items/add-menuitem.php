                            ...
                            <div id="Div_Price">
                                ...
                                switch ($NoOfSizeVariations){
                                    case 1 :
                                        echo "
                                            <div class='form-group row'>
                                                <label for='input-item-price-size1' class='col-3 col-form-label'>Addon-Item Price</label>
                                                <div class='col-9'>
                                                    <input name='__item_price_size1' id='input-item-price-size1' class='form-control' type='text' placeholder='ex. 20'>
                                                </div>
                                            </div>
                                    ...
                                    case 2 :
                                        echo "
                                            <div class='form-group row'>
                                                <label for='input-item-price-size1' class='col-3 col-form-label'>Addon-Item Price-Size1</label>
                                                <div class='col-9'>
                                                    <input name='__item_price_size1' id='input-item-price-size1' class='form-control' type='text' placeholder='40'>
                                                </div>
                                            </div>
                                             
                                            <div class='form-group row'>
                                                <label for='input-item-price-size2' class='col-3 col-form-label'>Addon-Item Price-Size2</label>
                                                <div class='col-9'>
                                                    <input name='__item_price_size2' id='input-item-price-size2' class='form-control' type='text' placeholder='40'>
                                                </div>
                                            </div>
                                    ...
                                    case 3 :
                                        echo "
                                            ...
                                            <div class='form-group row'>
                                             ...
                                             <div class='form-group row'>
                                                <label for='input-item-price-size3' class='col-3 col-form-label'>Addon-Item Price-Size3</label>
                                                <div class='col-9'>
                                                    <input name='__item_price_size3' id='input-item-price-size3' class='form-control' type='text' placeholder='40'>
                                                </div>
                                            </div>
                                        " ;
                                        break ;
