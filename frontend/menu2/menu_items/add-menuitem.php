                        ...
                        <form action="process-add-menuitem.php" method="post" enctype="multipart/form-data">
                            ...
                            <div id="Div_Price">
                                ...
                                for($i = 1; $i<=$NoOfSizeVariations; $i++){
                                    $Query = "SELECT * FROM `menu_meta_size_table` WHERE `size_category_code` = '$CategoryCode' AND `size_sr_no` = '$i' " ;
                                    ...
                                    echo "
                                        <div class='form-group row'>
                                            ...
                                            <div class='col-9'>
                                                <input name='__item_price_size$i' id='input-item-price-size$i' class='form-control' type='text' placeholder='ex. 20'>
                                            </div>
                                        </div>  
                                    " ;
                                }
