...
<!--    <link rel="stylesheet" href="../../../../lib/reset/reset.css" >-->
    ...
    $AllOpeningScreenImages = getAllOpeningScreenImages($DBConnectionBackend) ;
...
<!--                                <center>-->
                                ...
                                <ol id="yo" class="hidden-list-numbering" style="display: inline-block;float: left;">
                                    <?php
                                    foreach ($AllOpeningScreenImages as $Record){
                                ...
                                <ol id="sorting" class="listo-group" style="display: inline-block">
                                    ...
                                    foreach ($AllOpeningScreenImages as $Record){
                                        ...
                                        $ItemImageLink = $IMAGE_BACKENDFRONT_LINK_PATH.'/'.$Record['item_image'] ;
