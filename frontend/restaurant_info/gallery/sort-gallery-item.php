                        ...
                        <div class="push-md-3 col-md-6">
                            <div class="card">
                                <div class="card-block">
                                    <h1 class="text-center">Sort Gallery Items</h1>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!--                                <center>-->
                                ...
                                <ol id="sorting" class="listo-group" style="display: inline-block">
                                    <?php
                                    foreach ($ListOfAllGalleryItems as $Record){
                                        $ItemId =  $Record['gallery_item_id'] ;
                                        $ItemTitle = $Record['gallery_item_title'] ;
                                        $ItemImageLink = $IMAGE_BACKENDFRONT_LINK_PATH.'/'.$Record['gallery_item_image_name'] ;

                                        echo "<li id='$ItemId'><img src='$ItemImageLink' width='160px' height='90px' > </li>" ;
                                    }
                                    ?>
