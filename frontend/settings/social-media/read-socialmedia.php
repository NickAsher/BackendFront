                ...
                <div class="row">
                    ...
                    <div id="Section_AddNewItemForm" class="col-md-9" >
                                ...
                                foreach ($TempArray as $Record){
                                    ...
                                    echo "
                                        <div class='form-group row'>
                                            ...
                                            <div class='col-md-9'>
                                                <input name='__socialmedia_$SocialMedia_Id' id='input-social-media-$SocialMedia_Id' class='form-control' type='text'  value='$SocialMedia_Link' disabled>
                                            </div>
                                        </div>
                                    " ;
                        ...
                        <br><br>
                            ...
                            <div class="form-group row">
                                <div class="col-4" ></div>
                                <a class="col-4 btn btn-outline-info" href="edit-socialmedia.php" > Edit</a>
                                <div class="col-4" ></div>
                            </div>
